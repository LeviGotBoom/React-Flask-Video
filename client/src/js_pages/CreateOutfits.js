...
//             <Link to="/assembler" className="btn btn-outline-secondary">Assembler</Link>
//             <Link to="/season" className="btn btn-outline-secondary">Season</Link>
//         </div>
...
//         {/* Page Header Below Bar */}
//         <h2 className="text-center mb-4">Your Wardrobe</h2>
